...
<html lang="en">
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<div class="container">
			...
			$sql = "SELECT * FROM computer_technician";
				...
				if ($result->num_rows > 0) {
				    ...
				    while($row = $result->fetch_assoc()) {
				    	echo '<li class="list-group-item"><a href="mail.php"><button type="button" class="btn" style="float:right;">Book!</button></a>'.$row["name"].'<br>Rating:- '.$row["rating"].'<br>Cost/Hour:- '.$row["cost"].'</li>';
				    }
					echo "</ul>";
				} else {
				    echo "0 results";
